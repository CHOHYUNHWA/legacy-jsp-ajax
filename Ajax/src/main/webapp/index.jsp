		...
		<table class="table" style="text-align: center; border: 1px solid #dddddd">
			<thead>
				<tr>
					...
					<th style="backgroud-color: #fafafa; text-align: center;">나이</th>
					<th style="backgroud-color: #fafafa; text-align: center;">성별</th>
					<th style="backgroud-color: #fafafa; text-align: center;">이메일</th>
				</tr>
			</thead>
			<tbody id="ajaxTable">
			</tbody>
							...
							<div class="form-group" style="text-align: center; margin: 0 auto;">
								<div class="btn-group" data-toggle="buttons">
									<label class="btn btn-primary active">
										<input type="radio" id="registerGender" autocomplete="off" size="20" value="남자" checked>남자
									</label>
									<label class="btn btn-primary">
										<input type="radio" id="registerGender" autocomplete="off" size="20" value="여자">여자
									</label>
								</div>
							</div>
						</td>
